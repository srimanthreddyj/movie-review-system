...
const FilePreviewModal = ({ file, onClose }) => {
  ...
  return (
    <div className="modal-backdrop flex-center" onClick={onClose} style={{ zIndex: 1000 }}>
      <div className="modal-content" onClick={e => e.stopPropagation()} style={{ width: '90%', maxWidth: '1200px', padding: 0, overflow: 'hidden' }}>
        <div className="modal-header flex-between" style={{ padding: '1rem', backgroundColor: 'var(--bg-primary)', borderBottom: '1px solid var(--border-color)' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: '1rem' }}>
            <span className="modal-title" style={{ margin: 0 }}>{file.name}</span>
          ...
          <div style={{ display: 'flex', gap: '0.5rem' }}>
            ...
            <a href={file.webViewLink} target="_blank" rel="noopener noreferrer" className="btn flex-center" style={{ padding: '0.5rem' }} title="Open in Drive">
